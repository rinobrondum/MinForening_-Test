...
import {Box, LabeledInput, LabeledCheckbox, Button} from 'components'
...
const MobilepayClubDirectSubscriptionAgreementForm = ({acceptPaymentAgreement, paymentAgreementInfo, kevinPaymentMethod, createClubPaymentMethod, updateClubPaymentMethod}) => {
    ...
    >
      {({isValid, isSubmitting, status}) => (
        <Form>
          ...
          >
            {!status ? t('send') : t('send', {context: 'done'})}
          </Button>
        </Form>
      )}
    </Formik>
...
export default enhancer(MobilepayClubDirectSubscriptionAgreementForm)
