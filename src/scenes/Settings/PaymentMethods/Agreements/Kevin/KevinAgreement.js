...
import KevinAgreementForm from './KevinAgreementForm'
...
const KevinAgreement = ({getClubPaymentMethods, activeId}) => {
...
//   const [paragraphs, setParagraphs] = useState([])
  ...
  return isLoading ? (
    ...
    <>
      <H1>MinForening betalingsløsning opsætning</H1>

      <Box mb={3} mt={2}>
        Skriv til <a href="mailto:kontakt@minforening.dk">kontakt@minforening.dk</a> for at få lavet en MinForening betalingsløsning aftale.
      </Box>
...
export default enhancer(KevinAgreement)
